import { FACEBOOK, INSTAGRAM, LINKEDIN, WHATSAPP, YOUTUBE } from "@/utils/constants";
import { Copyright, Facebook, Instagram, Linkedin, MapPin, Youtube } from "lucide-react";
                ...
                <div className="flex gap-4 flex-1">
                    <div className="flex-1 flex flex-col gap-4 justify-between">
                        ...
                        <div className="flex gap-4 items-center">
                            ...
                            <a href={YOUTUBE} className="hover:opacity-75">
                                <Youtube size={24} />
                            </a>
                            <a href={WHATSAPP} className="hover:opacity-75">
