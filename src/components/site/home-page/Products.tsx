...
export const Products = () => {
    ...
    useEffect(() => {
        if ( categoryFilter ) return setProducts(productDataFromStore.filter(p => p.category?.name?.toLowerCase() == categoryFilter?.toLowerCase()));
                ...
                <div id="top-bar" className="items-center flex w-full text-white text-3xl">
                    ...
                    <div className="flex items-center gap-4 justify-self-end">
                        ...
                        <div className="relative">
                            ...
                            {showFilter && (
                                <div className="min-w-14 z-50 absolute top-[150%] right-0 rounded-lg bg-gray-600/50">
                                    ...
                                    <div className="flex justify-center text-lg items-center gap-2">
                                        ...
                                        >
                                            ...
                                            <Label htmlFor="<20k">0 - 20k</Label>
                                            </div>
                                            <div className="flex items-center space-x-2">
                                            <RadioGroupItem value="<40k" id="<40k" />
                                            <Label htmlFor="<40k">{"<"} 40k</Label>
                                            </div>
                                            <div className="flex items-center space-x-2">
                                            <RadioGroupItem value="<60k" id="<60k" />
                                            <Label htmlFor="<60k">{"<"} 60k</Label>
                                            </div>
                                            <div className="flex items-center space-x-2">
                                            <RadioGroupItem value="<80k" id="<80k" />
                                            <Label htmlFor="<80k">{"<"} 80k</Label>
                                            </div>
                                            <div className="flex items-center space-x-2">
