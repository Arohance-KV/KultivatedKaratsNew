...
export const HomePageNavBar = () => {
    ...
    return (
        <>
            {!isDashboard && <>
                {/* <div className="sm:flex !text-white hidden w-full flex-col gap-4 bg-[linear-gradient(to_bottom,_white_20%,_white_80%,_transparent_150%)] fixed top-0 left-0 right-0 z-30"> */}
