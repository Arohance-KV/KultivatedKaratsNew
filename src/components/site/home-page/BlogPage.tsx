...
export const BlogPage = () => {
    ...
    return (
        <section className="sm:p-20 p-[2%] flex flex-col justify-center items-center sm:gap-8 gap-4 !inria-serif-regular relative text-[#A68A7E]  w-full min-h-screen sm:mt-36 mt-14">
            <UIsideBar side="left" />
